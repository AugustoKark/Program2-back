...
import static edu.um.alumno.web.rest.TestUtil.createUpdateProxyForBean;
import static edu.um.alumno.web.rest.TestUtil.sameInstant;
import static edu.um.alumno.web.rest.TestUtil.sameNumber;
...
import edu.um.alumno.IntegrationTest;
...
class VentaResourceIT {
    ...
    public static Venta createEntity() {
        return new Venta().fechaVenta(DEFAULT_FECHA_VENTA).precioFinal(DEFAULT_PRECIO_FINAL);
    }
    ...
    public static Venta createUpdatedEntity() {
        return new Venta().fechaVenta(UPDATED_FECHA_VENTA).precioFinal(UPDATED_PRECIO_FINAL);
    }
